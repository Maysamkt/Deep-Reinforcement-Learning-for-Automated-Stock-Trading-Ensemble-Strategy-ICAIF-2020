...
class StockEnvTrade(gym.Env):
    """A stock trading environment for Gymnasium / OpenAI gym"""
    ...
    def __init__(self, df, day=0, turbulence_threshold=140,
        ...
        self.observation_space = spaces.Box(low=0, high=np.inf, shape=(181,), dtype=np.float32)
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            return np.array(self.state, dtype=np.float32), float(self.reward), bool(self.terminal), False, {}
